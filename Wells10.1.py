...
if (cntr == len(rows)):
	print "WellsReport is created successfully!"
else:
	print "WellsReport is NOT created successfully!"


WellsReports = "WellsReport1"
WellsReportsLayer = arcpy.env.workspace + "\\"  + WellsReports
arcpy.CreateFeatureclass_management(arcpy.env.workspace, WellsReports, "POINT", "", "DISABLED", "DISABLED", "", "", "0", "0", "0")
arcpy.DefineProjection_management(WellsReportsLayer, "GEOGCS['GCS_North_American_1983',DATUM['D_North_American_1983',SPHEROID['GRS_1980',6378137.0,298.257222101]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]]")
arcpy.AddField_management(WellsReportsLayer, "BORE_HOLE_ID", "LONG", "", "", "", "", "NON_NULLABLE", "REQUIRED", "")
...
cntr = 0
try:
	with arcpy.da.InsertCursor(WellsReports, ("SHAPE@XY", "BORE_HOLE_ID", "MOE_COUNTY_DESCR", "MOE_MUNICIPALITY_DESCR", "CON", "LOT", "STREET", "CITY", "UTMZONE", "EAST83", "NORTH83")) as cur:
		for row in rows:
			row = map(toSting, row)			
...
cntr = 0
try:
	with arcpy.da.InsertCursor(WellsReports, ("SHAPE@XY", "BORE_HOLE_ID", "GEO", "PLUG", "HOLE", "CM", "CAS", "SCRN", "WAT", "PT", "PTD", "DISINFECTED")) as cur:
		for row in rows:
			row = map(toSting, row)			
...
arcpy.JoinField_management(arcpy.env.workspace + "\\WellsReport", "BORE_HOLE_ID", arcpy.env.workspace + "\\WellsReport1", "BORE_HOLE_ID", "")
arcpy.JoinField_management(arcpy.env.workspace + "\\WellsReport", "BORE_HOLE_ID", arcpy.env.workspace + "\\WellsReport2", "BORE_HOLE_ID", "")
arcpy.FeatureClassToFeatureClass_conversion(arcpy.env.workspace + "\\WellsReport", arcpy.env.workspace, "WellsReports", "", "BORE_HOLE_ID \"BORE_HOLE_ID\" true false true 4 Long 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,BORE_HOLE_ID,-1,-1," + arcpy.env.workspace + "\\WellsReport,BORE_HOLE_ID,-1,-1," + arcpy.env.workspace + "\\WellsReport,BORE_HOLE_ID,-1,-1;WELL_ID \"WELL_ID\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,WELL_ID,-1,-1;BHK \"BHK\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,BHK,-1,-1;WELL_COMPLETED_DATE \"WELL_COMPLETED_DATE\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,WELL_COMPLETED_DATE,-1,-1;RECEIVED_DATE \"RECEIVED_DATE\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,RECEIVED_DATE,-1,-1;AUDIT_NO \"AUDIT_NO\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,AUDIT_NO,-1,-1;TAG \"TAG\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,TAG,-1,-1;CONTRACTOR \"CONTRACTOR\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,CONTRACTOR,-1,-1;SWL \"SWL\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,SWL,-1,-1;FINAL_STATUS_DESCR \"FINAL_STATUS_DESCR\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,FINAL_STATUS_DESCR,-1,-1;USE1 \"USE1\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,USE1,-1,-1;USE2 \"USE2\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,USE2,-1,-1;MOE_COUNTY_DESCR \"MOE_COUNTY_DESCR\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,MOE_COUNTY_DESCR,-1,-1;MOE_MUNICIPALITY_DESCR \"MOE_MUNICIPALITY_DESCR\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,MOE_MUNICIPALITY_DESCR,-1,-1;CON \"CON\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,CON,-1,-1;LOT \"LOT\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,LOT,-1,-1;STREET \"STREET\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,STREET,-1,-1;CITY \"CITY\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,CITY,-1,-1;UTMZONE \"UTMZONE\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,UTMZONE,-1,-1;EAST83 \"EAST83\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,EAST83,-1,-1;NORTH83 \"NORTH83\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,NORTH83,-1,-1;GEO \"GEO\" true true false 3000 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,GEO,-1,-1;PLUG \"PLUG\" true true false 1000 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,PLUG,-1,-1;HOLE \"HOLE\" true true false 300 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,HOLE,-1,-1;CM \"CM\" true true false 300 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,CM,-1,-1;CAS \"CAS\" true true false 300 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,CAS,-1,-1;SCRN \"SCRN\" true true false 300 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,SCRN,-1,-1;WAT \"WAT\" true true false 300 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,WAT,-1,-1;PT \"PT\" true true false 300 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,PT,-1,-1;PTD \"PTD\" true true false 500 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,PTD,-1,-1;DISINFECTED \"DISINFECTED\" true true false 255 Text 0 0 ,First,#," + arcpy.env.workspace + "\\WellsReport,DISINFECTED,-1,-1", "")
arcpy.Delete_management( arcpy.env.workspace + "\\WellsReport" , "FeatureClass")
